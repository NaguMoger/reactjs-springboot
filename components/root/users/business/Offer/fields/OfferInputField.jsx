  ...
  return (
    <div className={styles.form_field_2}>
      <section className={styles.name_section}>
        ...
        <input defaultValue={props.defaultValue} onChange={props.onChange} placeholder={props.placeholder} className={styles.h_n} type={props.type} id={props.name} name={props.name}/>
      </section>
      {props.error && (
