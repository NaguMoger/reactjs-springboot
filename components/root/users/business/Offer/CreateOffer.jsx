    ...
    <>
      <main className={styles.offer_main}>
        ...
        <form className={styles.form_offer} onSubmit={submitHandler}>
          <OfferInputField type="text" placeholder="ex: Painting, Swimming classes etc.." label="Hobbie Name" name="name" error={errors.name} onChange={(e) => setInfo({ ...info, name: e.target.value })}/>
          <OfferInputField type="text" placeholder="your offer in one sentence..." label="Slogan" name="slogan" error={errors.slogan} onChange={(e) => setInfo({ ...info, slogan: e.target.value })}/>
          ...
          <OfferTextaria label="Intro" name="intro" error={errors.intro} onChange={(e) => setInfo({...info, intro: e.target.value.replace(/\n\r?/g, "\n"),})}/>

          <OfferTextaria label="Description" name="description" error={errors.description} onChange={(e) => setInfo({ ...info, description: e.target.value })}/>

          <OfferInputField type="number" placeholder="" label="Price per entry" name="price" error={errors.price} onChange={(e) => setInfo({ ...info, price: e.target.value })}/>
          ...
          <OfferTextaria label="Contact info" name="contact" error={errors.contactInfo} onChange={(e) => setInfo({ ...info, contactInfo: e.target.value })}/>
